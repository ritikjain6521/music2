  ...
  async function displayallbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/jainsongs/") && !e.href.includes(".htaccess")) {
            ...
            let a = await fetch(`http://127.0.0.1:5502/public/jainsongs/${folder}/info.json`);
            let response = await a.json();
            console.log(response);

            // Dynamically create HTML to display album details
            cardContainer.innerHTML += `<div data-floder="${folder}" class="card ">
                <div class="play">
